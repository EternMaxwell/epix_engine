...
Schedule RenderT::render_schedule() {
    ...
    schedule.configure_sets(sets(RenderSystems::ExtractCommands, RenderSystems::PrepareMeshes, RenderSystems::ManageViews, RenderSystems::Queue,
                                 RenderSystems::PhaseSort, RenderSystems::Prepare, RenderSystems::Render, RenderSystems::Cleanup,
                                 RenderSystems::PostCleanup)
                                .chain());
    // (2) asset chain: ExtractCommands -> PrepareAssets -> PrepareMeshes -> Prepare.
    schedule.configure_sets(sets(RenderSystems::ExtractCommands, RenderSystems::PrepareAssets, RenderSystems::PrepareMeshes, RenderSystems::Prepare)
                                .chain());
    ...
    // (4) prepare sub-chain: PrepareResources -> PrepareResourcesCollectPhaseBuffers -> PrepareResourcesFlush -> PrepareBindGroups.
    schedule.configure_sets(sets(RenderSystems::PrepareResources, RenderSystems::PrepareResourcesCollectPhaseBuffers, RenderSystems::PrepareResourcesFlush,
