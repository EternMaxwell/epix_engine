...
EPIX_API Label::Label(meta::type_index t, size_t i) noexcept
    : m_type(t), m_index(i) {}
EPIX_API Label::Label() noexcept : m_type(meta::type_id<void>{}), m_index(0) {}
...
EPIX_API void Label::set_type(meta::type_index t) noexcept { m_type = t; }
EPIX_API void Label::set_index(size_t i) noexcept { m_index = i; }
EPIX_API meta::type_index Label::get_type() const noexcept { return m_type; }
