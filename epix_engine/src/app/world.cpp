...
EPIX_API const entt::registry& World::registry() const { return m_data.registry; }
EPIX_API bool World::entity_valid(Entity entity) const { return m_data.registry.valid(entity); }
