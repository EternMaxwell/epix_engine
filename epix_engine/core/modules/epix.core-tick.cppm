 ...
 * @brief Tick system partition for change detection
 */
...
export namespace epix::core {
    ...
    /**
     * Represents a point in time for change detection
     */
    struct Tick {
       private:
        uint32_t tick;
    ...
    /**
     * Tracks when a component was added and last modified
     */
    ...
    /**
     * References to component ticks for mutation
     */
    struct TickRefs {
       public:
