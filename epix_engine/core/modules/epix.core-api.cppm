 ...
 * @brief API module partition for epix.core
 * 
 * This module partition provides API macros and basic wrapper types
 */
...
// Export macro definitions as module-level declarations
export {
...
/**
 * Integer wrapper base type for strong typing
 */
...
// Export convenience macros for creating wrapper types
export {
