...
namespace epix::core {
WorldId world_id(const World& w) noexcept;const TypeRegistry& world_type_registry(const World& w) noexcept;
std::shared_ptr<TypeRegistry> world_type_registry_ptr(const World& w) noexcept;
const Components& world_components(const World& w) noexcept;Components& world_components_mut(World& w) noexcept;
const Entities& world_entities(const World& w) noexcept;Entities& world_entities_mut(World& w) noexcept;
const Storage& world_storage(const World& w) noexcept;Storage& world_storage_mut(World& w) noexcept;
const Archetypes& world_archetypes(const World& w) noexcept;Archetypes& world_archetypes_mut(World& w) noexcept; }
