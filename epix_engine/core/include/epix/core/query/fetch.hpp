...
EPIX_EXPORT template <world_query... Ts>
...
static_assert(world_query<Entity>);
template <>
...
static_assert(world_query<EntityLocation>);
template <>
...
static_assert(world_query<EntityRef>);
template <>
...
static_assert(world_query<EntityRefMut>);
template <>
...
static_assert(world_query<const Archetype&>);
template <>
...
static_assert(world_query<Ref<int>>);
template <typename T>
    requires(!std::is_reference_v<T> && !std::is_const_v<T>)
...
static_assert(world_query<Mut<int>>);
template <typename T>
    requires(!std::is_reference_v<T> && !std::is_const_v<T>)
...
static_assert(world_query<const int&>);
template <typename T>
    requires(!std::is_reference_v<T>)
...
EPIX_EXPORT template <world_query T>
...
static_assert(world_query<Opt<int&>>);
...
static_assert(query_data<Opt<int&>>);
...
static_assert(world_query<Has<int>>);
