...
struct MultithreadClassicExecutor : ScheduleExecutor {
...
struct SingleThreadExecutor : ScheduleExecutor {
    void execute(ScheduleSystems& schedule, World& world, const ExecutorConfig& config) override;
...
struct MultithreadFlatExecutor : ScheduleExecutor {
...
struct TaskflowExecutor : ScheduleExecutor {
    struct Impl;
...
struct AutoExecutor : ScheduleExecutor {
    struct Impl;
    std::unique_ptr<Impl> m_impl;
