...
static_assert(world_query<With<int>>);
...
static_assert(world_query<Without<int>>);
...
static_assert(world_query<Or<With<int>, Without<float>>>);
...
static_assert(world_query<Added<int>>);
...
static_assert(world_query<Modified<int>>);
