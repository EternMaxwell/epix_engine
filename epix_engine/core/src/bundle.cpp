...
BundleInfo BundleInfo::create(std::string_view bundle_type_name,
                              ...
                              std::vector<type_system::TypeId> component_ids,
                              BundleId id) {
...
ArchetypeId BundleInfo::insert_bundle_into_archetype(archetype::Archetypes& archetypes,
                                                     Storage& storage,
                                                     const Components& components,
...
std::optional<ArchetypeId> BundleInfo::remove_bundle_from_archetype(archetype::Archetypes& archetypes,
                                                                    Storage& storage,
                                                                    const Components& components,
