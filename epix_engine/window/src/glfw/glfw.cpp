...
void GLFWPlugin::update_size(Query<Item<Entity, Mut<window::Window>>> windows, ResMut<GLFWwindows> glfw_windows) {
...
EPIX_API void GLFWPlugin::toggle_window_mode(
    Query<Item<Entity, Mut<window::Window>>> windows,
    ResMut<GLFWwindows> glfw_windows,
...
EPIX_API void GLFWPlugin::destroy_windows(Query<Item<Entity, const window::Window&>> windows,
                                          ResMut<GLFWwindows> glfw_windows,
