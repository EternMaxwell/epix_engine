...
struct SFMLwindows : public std::unordered_map<Entity, std::shared_ptr<sf::WindowBase>> {};
...
struct PendingWindowPositions : public std::unordered_map<Entity, PendingWindowPosition> {};
