...
struct ExecutionState {
    ...
    utils::bit_vector ready_nodes;
    utils::bit_vector finished_nodes;
    utils::bit_vector entered_nodes;
    std::vector<utils::bit_vector> dependencies;
    std::vector<utils::bit_vector> children;
    utils::bit_vector condition_met_nodes;
    std::vector<utils::bit_vector> untest_conditions;
    std::vector<std::size_t> wait_count;  // number of dependencies + parents not yet satisfied
    std::vector<std::size_t> child_count;
    ecs::internal::async_queue finished_queue;
