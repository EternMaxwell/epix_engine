...
EPIX_EXPORT struct Access {
   ...
   private:
    utils::bit_vector component_read_writes;
    utils::bit_vector component_writes;
    utils::bit_vector resource_read_writes;
    utils::bit_vector resource_writes;
...
EPIX_EXPORT struct FilteredAccess {
    ...
    const utils::bit_vector& required() const noexcept { return _required; }
    /** @brief Get a mutable reference to the required component set. */
    utils::bit_vector& required_mut() noexcept { return _required; }
...
EPIX_EXPORT struct FilteredAccessSet {
   public:
