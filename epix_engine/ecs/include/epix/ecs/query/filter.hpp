...
static_assert(internal::world_query<With<int>>);
...
static_assert(query_filter<With<int>>);
...
static_assert(internal::world_query<Without<int>>);
...
static_assert(query_filter<Without<int>>);

// implements for Or<Fs...>
template <query_filter T>
struct OrFetch {
    WorldQuery<T>::Fetch fetch;
    bool matches = false;
};

template <internal::world_query... Fs>
...
static_assert(internal::world_query<Or<With<int>, Without<float>>>);
...
static_assert(internal::world_query<Added<int>>);
...
static_assert(internal::world_query<Modified<int>>);
...
static_assert(query_filter<Modified<int>>);
