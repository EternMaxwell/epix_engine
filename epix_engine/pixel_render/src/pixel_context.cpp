...
EPIX_API void PixelPipeline::Context::begin(
    ...
    model_buffer_info.setBuffer(model_buffer);
    model_buffer_info.setOffset(0);
    model_buffer_info.setRange(VK_WHOLE_SIZE);
    vk::WriteDescriptorSet model_descriptor_write;
    model_descriptor_write.setDstSet(descriptor_set);
    ...
    vk::WriteDescriptorSet descriptor_writes[] = {
        descriptor_write, model_descriptor_write
    };
