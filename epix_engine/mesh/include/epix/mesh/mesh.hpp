...
struct MeshAttributeLayout : std::map<std::uint32_t, MeshAttribute> {
...
inline const MeshAttribute Mesh::ATTRIBUTE_POSITION{"position", 0, wgpu::VertexFormat::eFloat32x3};
inline const MeshAttribute Mesh::ATTRIBUTE_COLOR{"color", 1, wgpu::VertexFormat::eFloat32x4};
inline const MeshAttribute Mesh::ATTRIBUTE_NORMAL{"normal", 2, wgpu::VertexFormat::eFloat32x3};
inline const MeshAttribute Mesh::ATTRIBUTE_UV0{"uv0", 3, wgpu::VertexFormat::eFloat32x2};
inline const MeshAttribute Mesh::ATTRIBUTE_UV1{"uv1", 4, wgpu::VertexFormat::eFloat32x2};
