...
struct StringLoader {
    ...
    static std::string load(const std::filesystem::path& path, epix::assets::LoadContext& context) {
...
struct AnotherLoader {
    ...
    static int load(const std::filesystem::path& path, epix::assets::LoadContext& context) {
