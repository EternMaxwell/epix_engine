...
using DirectoryError = std::variant<NotFoundError, IoError, ExceptionError>;

enum class DirEventType { FileAdded, FileModified, FileRemoved, DirAdded, DirRemoved, Moved };
