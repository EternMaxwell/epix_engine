...
EPIX_EXPORT struct MemoryAssetReader : public assets::AssetReader {
   public:
...
EPIX_EXPORT struct MemoryAssetWriter : public assets::AssetWriter {
   public:
...
EPIX_EXPORT struct MemoryAssetWatcher : public assets::AssetWatcher {
   public:
