...
struct MemoryAssetReader : public assets::AssetReader {
   public:
...
struct MemoryAssetWriter : public assets::AssetWriter {
   public:
...
struct MemoryAssetWatcher : public assets::AssetWatcher {
   public:
