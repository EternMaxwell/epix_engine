...
EPIX_EXPORT enum class LogEntryKind {
    BeginProcessing,
    EndProcessing,
    UnrecoverableError,
};

EPIX_EXPORT struct LogEntry {
    LogEntryKind kind;
...
EPIX_EXPORT struct ProcessorTransactionLog;

EPIX_EXPORT struct ProcessorTransactionLogFactory {
...
EPIX_EXPORT namespace log_entry_errors {
...
EPIX_EXPORT using LogEntryError = std::variant<log_entry_errors::DuplicateTransaction,
...
EPIX_EXPORT namespace validate_log_errors {
...
EPIX_EXPORT using ValidateLogError = std::variant<validate_log_errors::UnrecoverableError,
...
EPIX_EXPORT struct FileTransactionLogFactory : ProcessorTransactionLogFactory {
    std::filesystem::path file_path;
