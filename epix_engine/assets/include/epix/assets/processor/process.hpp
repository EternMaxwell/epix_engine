...
EPIX_EXPORT struct AssetProcessor;
...
EPIX_EXPORT namespace process_errors {
...
EPIX_EXPORT using ProcessError = std::variant<process_errors::MissingAssetLoaderForExtension,
...
EPIX_EXPORT enum class ProcessResultKind {
    Processed,
    SkippedNotChanged,
    Ignored,
};

EPIX_EXPORT struct ProcessResult {
...
EPIX_EXPORT enum class ProcessStatus {
    Processed,
    Failed,
    NonExistent,
};
...
EPIX_EXPORT template <typename LoaderSettings, typename TransformerSettings, typename SaverSettings>
...
EPIX_EXPORT template <AssetLoader L, AssetTransformer T, AssetSaver S>
...
EPIX_EXPORT namespace get_processor_errors {
    struct Missing {
        std::string name;
    };
    struct Ambiguous {
...
EPIX_EXPORT using GetProcessorError = std::variant<get_processor_errors::Missing, get_processor_errors::Ambiguous>;
