...
template <typename LoaderSettings, typename TransformerSettings, typename SaverSettings>
...
using GetProcessorError = std::variant<get_processor_errors::Missing, get_processor_errors::Ambiguous>;
