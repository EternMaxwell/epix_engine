...
using LoadState = std::variant<LoadStateOK, std::shared_ptr<AssetLoadError>>;

/** @brief Load state of an asset's direct dependencies. */
struct DependencyLoadState : std::variant<LoadStateOK, std::shared_ptr<AssetLoadError>> {
...
struct RecursiveDependencyLoadState : std::variant<LoadStateOK, std::shared_ptr<AssetLoadError>> {
    using base = std::variant<LoadStateOK, std::shared_ptr<AssetLoadError>>;
    using base::base;
