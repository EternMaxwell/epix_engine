 ...
 */
template <typename T, typename F, typename R = std::invoke_result_t<F, std::size_t, std::span<const T>>>
 ...
 */
template <typename T, typename F, typename R = std::invoke_result_t<F, std::size_t, std::span<T>>>
