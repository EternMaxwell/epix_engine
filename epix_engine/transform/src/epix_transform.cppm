// epix_transform - Pure C++20 Module (No Headers)
// Transform component system for 3D transformations

module;

// Global module fragment - standard library and GLM
#include <deque>
#include <unordered_map>
#include <tuple>

// GLM - third-party math library
#include <glm/glm.hpp>
#include <glm/gtc/matrix_transform.hpp>
#include <glm/gtc/quaternion.hpp>
#include <glm/gtc/type_ptr.hpp>

export module epix_transform;
