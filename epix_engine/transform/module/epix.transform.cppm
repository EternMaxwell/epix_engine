 ...
 * @brief C++20 module interface for the transform system.
 *
 * This module provides Transform and GlobalTransform components
 * for entity positioning, rotation, and scaling in 3D space.
 */
module;
...
/**
 * @brief Local transform component with position, rotation, and scale.
 *
 * @tparam T The floating-point type for transform values.
 */
...
/**
 * @brief Global transform computed from local transform and hierarchy.
 */
...
/**
 * @brief System sets for transform calculation.
 */
...
/**
 * @brief Plugin for the transform system.
 */
