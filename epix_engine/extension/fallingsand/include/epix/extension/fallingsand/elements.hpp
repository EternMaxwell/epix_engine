...
inline constexpr std::size_t kDim = 2;
...
using Action = std::variant<SpawnNearby, TransformTo, Despawn, Ignite, Extinguish>;
...
enum class ElementRegistryError {
    NameAlreadyExists,
    NameNotFound,
    InvalidBaseId,
