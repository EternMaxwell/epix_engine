...
// /** @brief Optionally builds/updates a separate debug mesh for Body-type sentinel elements
//  *  (those with alpha == 0 placed by the pixel-body plugin).  Only active when
//  *  SandWorld::show_body_debug() returns true.  Add this system to your schedule if you
//  *  want the overlay; omit it if not needed. */
