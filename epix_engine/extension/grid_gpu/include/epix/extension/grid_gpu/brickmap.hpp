...
// -------------------------------------------------------
inline constexpr std::string_view kBrickmapGridSlangSource = R"slang(
...
struct BrickmapConfig {
    std::size_t brick_size = 8;  // per-axis (2, 4, 8, or 16)
};

struct BrickmapUploadError {
...
template <epix::ext::grid::viewable_grid G>
