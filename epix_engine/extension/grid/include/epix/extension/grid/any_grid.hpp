 ...
 */
enum class grid_category : unsigned {
    none             = 0,
...
constexpr auto operator|(grid_category a, grid_category b) -> grid_category {
    return static_cast<grid_category>(static_cast<unsigned>(a) | static_cast<unsigned>(b));
}
constexpr auto operator&(grid_category a, grid_category b) -> grid_category {
    return static_cast<grid_category>(static_cast<unsigned>(a) & static_cast<unsigned>(b));
}
constexpr auto has_category(grid_category val, grid_category flag) -> bool {
